...
(function($){
	...
	_bindEvent = function(setting) {
		...
		var c = consts.event;
		o.bind(c.ADDNOD, function (event, treeId, treeNode) {
			tools.apply(setting.callback.onAddnod, [event, treeId, treeNode]);
		});
	...
	_view = {
			addNewBtn: function(setting, node) {
				...
				addStr = "<span class='button add' style='clear:both; float:none;' id='" + node.tId + consts.id.ADD + "' title='"+tools.apply(setting.edit.addTitle, [setting.treeId, node], setting.edit.addTitle)+"' treeNode"+consts.id.ADD+" style='display:none;'  onfocus='this.blur();'></span>";
				aObj.append(addStr);

				$("#" + node.tId + consts.id.ADD).bind('click',
					function() {
						if (!tools.uCanDo(setting) || tools.apply(setting.callback.beforeAddNod, [setting.treeId, node], true) == false) return false;
						view.addNod(setting, node);
						return false;
					}
					).show();
			},
		addEditBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			editStr = "<span class='button edit' style='clear:both; float:none;' id='" + node.tId + consts.id.EDIT + "' title='"+tools.apply(setting.edit.renameTitle, [setting.treeId, node], setting.edit.renameTitle)+"' treeNode"+consts.id.EDIT+" style='display:none;'></span>";
			aObj.append(editStr);
		...
		addRemoveBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			removeStr = "<span class='button remove' style='clear:both; float:none;' id='" + node.tId + consts.id.REMOVE + "' title='"+tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle)+"' treeNode"+consts.id.REMOVE+" style='display:none;'></span>";
