...
<script type="text/javascript" src="/styles/dee/js/restSrv/flowBringBack.js"></script>
<form id="pagerForm" method="post" action="/dee/restSrv!deeList.do">
...
<div class="pageHeader">
	<form id="deeListSearchDlg" rel="pagerForm" method="post" action="/dee/restSrv!deeList.do" onsubmit="return dwzSearch(this, 'dialog');">
		<div class="searchBar">
			<div class="subBar">
				<ul>
					<li>
